...
try
{
    ...
    $winrmLUrl = "https://raw.github.com/PCManticore/windows-openstack-imaging-tools/master/SetupWinRMAccess.ps1"
    ...
    $unattendXMLUrl = "https://raw.githubusercontent.com/PCManticore/windows-openstack-imaging-tools/master/Unattend.xml"
